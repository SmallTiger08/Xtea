...
namespace XTEA
{
    ...
    class Xtea
    {
        ...
        public void encrypt(byte[] bytes, int off, int len)
        {
            if (len % ALIGN != 0)
            {
                Console.WriteLine(len + "unaligned with" + ALIGN);
                return;
            }
        ...
        private void decryptBlock(byte[] input, byte[] output, int off)
        {
        int y = (input[off] << 24) | ((input[off+1] & 255) << 16) | ((input[off+2] & 255) << 8) | (input[off+3] & 255);
        int z = (input[off+4] << 24) | ((input[off+5] & 255) << 16) | ((input[off+6] & 255) << 8) | (input[off+7] & 255);
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k31; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k30;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k29; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k28;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k27; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k26;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k25; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k24;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k23; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k22;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k21; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k20;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k19; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k18;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k17; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k16;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k15; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k14;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k13; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k12;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k11; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k10;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k9; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k8;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k7; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k6;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k5; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k4;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k3; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k2;
        z -= ((((int)((uint)y >> 5)) ^ (y << 4)) + y) ^ k1; y -= (((z << 4) ^ ((int)((uint)z >> 5))) + z) ^ k0;
        output[off] = (byte) (y >> 24); output[off+1] = (byte) (y >> 16); output[off+2] = (byte) (y >> 8); output[off+3] = (byte) y;
        output[off+4] = (byte) (z >> 24); output[off+5] = (byte) (z >> 16); output[off+6] = (byte) (z >> 8); output[off+7] = (byte) z;
    }
